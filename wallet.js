...
export const ITEMS = {
  // Common
  fertilizer:        { id:'fertilizer',        rarity:0, label:'Fertilizer',        em:'🌻', desc:'Adds three +50% future waterings; no instant GP', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Common' },
  watering_boost:    { id:'watering_boost',     rarity:0, label:'Watering Boost',    em:'💦', desc:'Adds one +50% future watering; no instant GP',role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Common' },
  compost:           { id:'compost',            rarity:0, label:'Compost',            em:'♻️', desc:'Adds one streak day; helps reach stronger stages sooner', role:'Streak Builder', roleCopy:'Speed up stage progress so a Seed can become more valuable over the season.', rarLabel:'Common' },
  growth_tonic:      { id:'growth_tonic',       rarity:0, label:'Growth Tonic',      em:'🧪', desc:'Adds +20 Growth Points immediately', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Common' },
  // Uncommon
  miracle_grow:      { id:'miracle_grow',       rarity:1, label:'Miracle Grow',      em:'⚡', desc:'Doubles GP from the next watering; no instant GP', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Uncommon' },
  mulch:             { id:'mulch',              rarity:1, label:'Mulch',              em:'🍂', desc:'Protects future GP through about three missed watering days',role:'Protection Item', roleCopy:'Protect the future GP you would lose if a Seed dries out or dies.', rarLabel:'Uncommon' },
  rain_barrel:       { id:'rain_barrel',        rarity:1, label:'Rain Barrel',       em:'🪣', desc:'Refreshes the watering timer once to protect future GP', role:'Protection Item', roleCopy:'Protect the future GP you would lose if a Seed dries out or dies.', rarLabel:'Uncommon' },
  super_soil:        { id:'super_soil',         rarity:1, label:'Super Soil',        em:'🌍', desc:'Adds three streak days; helps reach stronger stages sooner', role:'Streak Builder', roleCopy:'Speed up stage progress so a Seed can become more valuable over the season.', rarLabel:'Uncommon' },
  sunstone:          { id:'sunstone',           rarity:1, label:'Sunstone',          em:'🌟', desc:'Adds +30 Growth Points immediately', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Uncommon' },
  // Rare
  revival_kit:       { id:'revival_kit',        rarity:2, label:'Revival Kit',       em:'💫', desc:'Revives a dead current Seed so it can earn future GP again', role:'Recovery Item', roleCopy:'Bring a dead current-cycle Seed back so it can earn again.', rarLabel:'Rare' },
  double_dose:       { id:'double_dose',        rarity:2, label:'Double Dose',       em:'🔥', desc:'Doubles next watering and adds two +50% future waterings',role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Rare' },
  drought_shield:    { id:'drought_shield',     rarity:2, label:'Drought Shield',    em:'🛡️', desc:'Protects future GP through about seven missed watering days',role:'Protection Item', roleCopy:'Protect the future GP you would lose if a Seed dries out or dies.', rarLabel:'Rare' },
  ancient_bark:      { id:'ancient_bark',       rarity:2, label:'Ancient Bark',      em:'🌳', desc:'Adds +50 Growth Points immediately', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Rare' },
  moon_water:        { id:'moon_water',         rarity:2, label:'Moon Water',        em:'🌕', desc:'Adds five +50% future waterings; no instant GP', role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Rare' },
  earth_core:        { id:'earth_core',         rarity:2, label:'Earth Core',        em:'💎', desc:'Adds five +50% future waterings; no instant GP', role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Rare' },
  // Legendary
  bottomless_can:    { id:'bottomless_can',     rarity:3, label:'Bottomless Can',    em:'✨🪣✨', desc:'Auto-waters one selected Seed for the timed window',role:'Protection Item', roleCopy:'Protect the future GP you would lose if a Seed dries out or dies.', rarLabel:'Legendary' },
  philosophers_soil: { id:'philosophers_soil',  rarity:3, label:'Philosopher\'s Soil',em:'🏆', desc:'Adds ten +50% future waterings; no instant GP', role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Legendary' },
  timeless_seed:     { id:'timeless_seed',      rarity:3, label:'Timeless Seed',     em:'⏳', desc:'Refreshes timer and adds five streak days for future GP safety', role:'Streak Builder', roleCopy:'Speed up stage progress so a Seed can become more valuable over the season.', rarLabel:'Legendary' },
  crystal_water:     { id:'crystal_water',      rarity:3, label:'Crystal Water',     em:'💠', desc:'Doubles next watering and adds nine +50% future waterings',role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Legendary' },
  forest_heart:      { id:'forest_heart',       rarity:3, label:'Forest Heart',      em:'❤️‍🔥', desc:'Adds +5 GP to every future watering on one Seed',role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Legendary'},
};
