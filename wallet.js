...
export const ITEMS = {
  // Common
  fertilizer:        { id:'fertilizer',        rarity:0, label:'Fertilizer',        em:'🌻', desc:'Use before watering: adds three +50% future waterings; no instant GP', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Common' },
  watering_boost:    { id:'watering_boost',     rarity:0, label:'Watering Boost',    em:'💦', desc:'Use before watering: adds one +50% future watering; no instant GP',role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Common' },
  ...
  growth_tonic:      { id:'growth_tonic',       rarity:0, label:'Growth Tonic',      em:'🧪', desc:'Use before or after watering: adds +20 Growth Points immediately', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Common' },
  // Uncommon
  miracle_grow:      { id:'miracle_grow',       rarity:1, label:'Miracle Grow',      em:'⚡', desc:'Use before watering: doubles GP from the next watering; no instant GP', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Uncommon' },
  mulch:             { id:'mulch',              rarity:1, label:'Mulch',              em:'🍂', desc:'Use before missed time: protects future GP through about three missed watering days',role:'Protection Item', roleCopy:'Protect the future GP you would lose if a Seed dries out or dies.', rarLabel:'Uncommon' },
  rain_barrel:       { id:'rain_barrel',        rarity:1, label:'Rain Barrel',       em:'🪣', desc:'Use before a Seed gets too dry: refreshes the timer to protect future GP', role:'Protection Item', roleCopy:'Protect the future GP you would lose if a Seed dries out or dies.', rarLabel:'Uncommon' },
  ...
  sunstone:          { id:'sunstone',           rarity:1, label:'Sunstone',          em:'🌟', desc:'Use before or after watering: adds +30 Growth Points immediately', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Uncommon' },
  // Rare
  revival_kit:       { id:'revival_kit',        rarity:2, label:'Revival Kit',       em:'💫', desc:'Use after a Seed dies: revives it so it can earn future GP again', role:'Recovery Item', roleCopy:'Bring a dead current-cycle Seed back so it can earn again.', rarLabel:'Rare' },
  double_dose:       { id:'double_dose',        rarity:2, label:'Double Dose',       em:'🔥', desc:'Use before watering: doubles next watering and adds two +50% future waterings',role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Rare' },
  drought_shield:    { id:'drought_shield',     rarity:2, label:'Drought Shield',    em:'🛡️', desc:'Use before longer time away: protects future GP through about seven missed watering days',role:'Protection Item', roleCopy:'Protect the future GP you would lose if a Seed dries out or dies.', rarLabel:'Rare' },
  ancient_bark:      { id:'ancient_bark',       rarity:2, label:'Ancient Bark',      em:'🌳', desc:'Use before or after watering: adds +50 Growth Points immediately', role:'Growth Booster', roleCopy:'Increase GP directly now or make upcoming waterings worth more.', rarLabel:'Rare' },
  moon_water:        { id:'moon_water',         rarity:2, label:'Moon Water',        em:'🌕', desc:'Use before watering: adds five +50% future waterings; no instant GP', role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Rare' },
  earth_core:        { id:'earth_core',         rarity:2, label:'Earth Core',        em:'💎', desc:'Use before watering: adds five +50% future waterings; no instant GP', role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Rare' },
  // Legendary
  bottomless_can:    { id:'bottomless_can',     rarity:3, label:'Bottomless Can',    em:'✨🪣✨', desc:'Use before time away: auto-waters one selected Seed for the timed window',role:'Protection Item', roleCopy:'Protect the future GP you would lose if a Seed dries out or dies.', rarLabel:'Legendary' },
  philosophers_soil: { id:'philosophers_soil',  rarity:3, label:'Philosopher\'s Soil',em:'🏆', desc:'Use before watering, preferably early: adds ten +50% future waterings; no instant GP', role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Legendary' },
  ...
  forest_heart:      { id:'forest_heart',       rarity:3, label:'Forest Heart',      em:'❤️‍🔥', desc:'Use before watering, preferably early: adds +5 GP to every future watering on one Seed',role:'Power Enhancer', roleCopy:'Make one Seed stronger for future waterings or the rest of the cycle.', rarLabel:'Legendary'},
};
