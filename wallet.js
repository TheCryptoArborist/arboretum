...
export const ITEMS = {
  // Common
  fertilizer:        { id:'fertilizer',        rarity:0, label:'Fertilizer',        em:'🌻', desc:'Loads three future watering boosts', role:'Growth Booster', roleCopy:'Score more GP now or on upcoming waterings.', rarLabel:'Common' },
  watering_boost:    { id:'watering_boost',     rarity:0, label:'Watering Boost',    em:'💦', desc:'Loads one future watering boost',role:'Growth Booster', roleCopy:'Score more GP now or on upcoming waterings.', rarLabel:'Common' },
  compost:           { id:'compost',            rarity:0, label:'Compost',            em:'♻️', desc:'Adds one watering streak day immediately', role:'Streak Builder', roleCopy:'Add streak days so a Seed reaches stronger growth stages sooner.', rarLabel:'Common' },
  growth_tonic:      { id:'growth_tonic',       rarity:0, label:'Growth Tonic',      em:'🧪', desc:'Adds twenty Growth Points immediately', role:'Growth Booster', roleCopy:'Score more GP now or on upcoming waterings.', rarLabel:'Common' },
  // Uncommon
  miracle_grow:      { id:'miracle_grow',       rarity:1, label:'Miracle Grow',      em:'⚡', desc:'Doubles Growth Points from the next watering', role:'Growth Booster', roleCopy:'Score more GP now or on upcoming waterings.', rarLabel:'Uncommon' },
  mulch:             { id:'mulch',              rarity:1, label:'Mulch',              em:'🍂', desc:'Protects through about three missed watering days',role:'Protection Item', roleCopy:'Cover missed watering time before a Seed wilts or dies.', rarLabel:'Uncommon' },
  rain_barrel:       { id:'rain_barrel',        rarity:1, label:'Rain Barrel',       em:'🪣', desc:'Refreshes the watering timer once', role:'Protection Item', roleCopy:'Cover missed watering time before a Seed wilts or dies.', rarLabel:'Uncommon' },
  super_soil:        { id:'super_soil',         rarity:1, label:'Super Soil',        em:'🌍', desc:'Adds three watering streak days immediately', role:'Streak Builder', roleCopy:'Add streak days so a Seed reaches stronger growth stages sooner.', rarLabel:'Uncommon' },
  sunstone:          { id:'sunstone',           rarity:1, label:'Sunstone',          em:'🌟', desc:'Adds thirty Growth Points immediately', role:'Growth Booster', roleCopy:'Score more GP now or on upcoming waterings.', rarLabel:'Uncommon' },
  // Rare
  revival_kit:       { id:'revival_kit',        rarity:2, label:'Revival Kit',       em:'💫', desc:'Revives a dead current Seed', role:'Recovery Item', roleCopy:'Bring a dead current-cycle Seed back into play.', rarLabel:'Rare' },
  double_dose:       { id:'double_dose',        rarity:2, label:'Double Dose',       em:'🔥', desc:'Doubles next watering and loads two future watering boosts',role:'Growth Booster', roleCopy:'Score more GP now or on upcoming waterings.', rarLabel:'Rare' },
  drought_shield:    { id:'drought_shield',     rarity:2, label:'Drought Shield',    em:'🛡️', desc:'Protects through about seven missed watering days',role:'Protection Item', roleCopy:'Cover missed watering time before a Seed wilts or dies.', rarLabel:'Rare' },
  ancient_bark:      { id:'ancient_bark',       rarity:2, label:'Ancient Bark',      em:'🌳', desc:'Adds fifty Growth Points immediately', role:'Growth Booster', roleCopy:'Score more GP now or on upcoming waterings.', rarLabel:'Rare' },
  moon_water:        { id:'moon_water',         rarity:2, label:'Moon Water',        em:'🌕', desc:'Loads five future watering boosts', role:'Power Enhancer', roleCopy:'Invest in your best Seed for a stronger rest-of-cycle push.', rarLabel:'Rare' },
  earth_core:        { id:'earth_core',         rarity:2, label:'Earth Core',        em:'💎', desc:'Loads five future watering boosts', role:'Power Enhancer', roleCopy:'Invest in your best Seed for a stronger rest-of-cycle push.', rarLabel:'Rare' },
  // Legendary
  bottomless_can:    { id:'bottomless_can',     rarity:3, label:'Bottomless Can',    em:'✨🪣✨', desc:'Timed auto-water protection for one selected Seed',role:'Protection Item', roleCopy:'Cover missed watering time before a Seed wilts or dies.', rarLabel:'Legendary' },
  philosophers_soil: { id:'philosophers_soil',  rarity:3, label:'Philosopher\'s Soil',em:'🏆', desc:'Loads ten future watering boosts', role:'Power Enhancer', roleCopy:'Invest in your best Seed for a stronger rest-of-cycle push.', rarLabel:'Legendary' },
  timeless_seed:     { id:'timeless_seed',      rarity:3, label:'Timeless Seed',     em:'⏳', desc:'Refreshes timer and adds five streak days', role:'Streak Builder', roleCopy:'Add streak days so a Seed reaches stronger growth stages sooner.', rarLabel:'Legendary' },
  crystal_water:     { id:'crystal_water',      rarity:3, label:'Crystal Water',     em:'💠', desc:'Doubles next watering and loads nine future watering boosts',role:'Power Enhancer', roleCopy:'Invest in your best Seed for a stronger rest-of-cycle push.', rarLabel:'Legendary' },
  forest_heart:      { id:'forest_heart',       rarity:3, label:'Forest Heart',      em:'❤️‍🔥', desc:'Permanent future watering bonus for one Seed',role:'Power Enhancer', roleCopy:'Invest in your best Seed for a stronger rest-of-cycle push.', rarLabel:'Legendary'},
};
