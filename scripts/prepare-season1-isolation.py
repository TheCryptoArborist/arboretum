...
# Adapt original tests to additional state; never skip a production check in tests.
...
tests=(AREA/'isolation-tests.move.inc').read_text().replace('let _ = destroy_test_registry(r);','let (_, _) = destroy_test_registry(r);')
...
[addresses]
season1 = "0x0"
# These aliases are referenced solely by test-only fixture modules and tests.
